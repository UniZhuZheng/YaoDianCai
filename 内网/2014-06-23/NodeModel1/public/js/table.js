    ...
    if (TableInfoData.length > 0) {
        ...
        for (var i = 0,tidl = TableInfoData.length; i < tidl; i++) {
            ...
            if (TableInfoData[i].tablename == selected) {
                ...
                tablebtn.append("<a href='/main' class='selected' data-role='button' data-inline='true' data-corners='false' data-direction='reverse'>");
                tablebtn.append(TableInfoData[i].tablename );
                tablebtn.append("</a></div>");

            } else {
                tablebtn.append(blocks[i % 3]);
                tablebtn.append("<a href='/main' data-role='button' data-inline='true' data-corners='false' data-direction='reverse'>");
                tablebtn.append(TableInfoData[i].tablename);
                tablebtn.append("</a></div>");
            }
