...
namespace Uni.Core.Database.Sql
{
    public class SqlQuery : ISqlInstruction
    {
        ...
        {
            if ("sqlserver".Equals(dialect.TypeOfDataBase))
            {
                return ToString_SqlServer(dialect);
            }
            else 
            { 
                return ToString_OtherSql(dialect);
            }
        }
        public string ToString_SqlServer(ISqlDialect dialect)
        {
        ...
        public string ToString_OtherSql(ISqlDialect dialect)
        {
            StringBuilder sql = new StringBuilder();
        ...
        public object[] GetParameters()
        {
            ...
            if (having != Exp.Empty)
            {
                parameters.AddRange(having.GetParameters());
            }
        ...
        public SqlQuery SetLimitId(string limitId)
        {
