...
namespace Uni.Core.Database.Sql.Dialects
{
    ...
    {
        public string TypeOfDataBase { get { return "mysql"; } }
        public string IdentityQuery { get { return "last_insert_id()"; } }
        public string Autoincrement { get { return "auto_increment"; } }
        public string InsertIgnore  { get { return "insert ignore"; } }

        public bool SupportMultiTableUpdate { get { return true; } }
        public bool SeparateCreateIndex { get { return false; } }
