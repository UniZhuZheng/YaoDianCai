...
function MenuImgSubmit() {
    if (stateSelectName == null || stateSelectName == "") {
        layer.alert("音乐名获取失败，请重新操作。", 12);
        return;
    }
    $("#menuimgform").ajaxForm({
        url: "/action/MusicAction.ashx?option=OP_Upload&SID=" + SID + "&name=" + encodeURI(stateSelectName),
