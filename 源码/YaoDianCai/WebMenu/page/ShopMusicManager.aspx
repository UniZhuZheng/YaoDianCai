<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopMusicManager.aspx.cs" Inherits="Uni.WebMenu.page.ShopMusicManager" %>

<!DOCTYPE html>
<html>
<head>
    <title>商家音乐界面</title>
    <link href="/res/css/shopmusic.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="/res/js/shopmusic.js"></script>
    ...
    <div class="body_panel">
        ...
        <div class="navigation">
            <div class="navigation_left">
                ...
                <div class="navigation_left_middle" style="width:90px;"><span>商家音乐列表</span></div>
        ...
        <div class="shopsdishlist">
            <div class="shopsdishlist_center">
                <div class="shopsdishlist_th">
                    ...
                    <div class="shopsdishlist_th_2">音乐名</div>
                    ...
                    <div class="shopsdishlist_th_7">音乐上传</div>
                </div>
            </div>
        </div>
    </div>
