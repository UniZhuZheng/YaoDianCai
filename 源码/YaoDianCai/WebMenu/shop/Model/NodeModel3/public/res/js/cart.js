...
function Cart_List() {
    ...
    for (var i = 0; i < shopCarData.length; i++) {
        cartStr += '<li>' +
                    ...
                    '<div class="menu_name_en">' + DishInfoEn.DishName[shopCarData[i].dishName] + '</div>' +
...
function Cart_Confirm() {
    ...
    for (var i = 0; i < shopCarData.length; i++) {
        cartStr += '<div class="Cart_Confirm_item">'+
                        ...
                        '<div class="Cart_Confirm_item_name_en">' + DishInfoEn.DishName[shopCarData[i].dishName] + '</div>' +
                    '</div>';
    }
