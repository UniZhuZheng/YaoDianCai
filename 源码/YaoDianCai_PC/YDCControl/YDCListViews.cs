...
namespace YDCControl
{
    public partial class YDCListViews : ListView
    {
        #region Fileds
        ...
        private bool _drawBackLine = false;
        ...
        {
            get { return _drawBackLine; }
            set { _drawBackLine = value; }
        }
        ...
        private void DrawSubItemDetails( DrawListViewSubItemEventArgs e)
        {
            ...
            if (bSelected && (base.FullRowSelect || (!base.FullRowSelect && bFistItem)))
            {
                backRect.Height--;
                Color baseColor = _selectedColor;
                Color borderColor = _selectedColor;
            ...
            {
                Color backColor = e.ItemIndex % 2 == 0 ? _rowBackColor1 : _rowBackColor2;
                Color borderColor = _selectedColor;
                using (SolidBrush brush = new SolidBrush(backColor))
                {
        ...
        {
            private YDCListViews _owner;

            public HeaderNativeWindow(YDCListViews owner)
                : base()
            {
                _owner = owner;
