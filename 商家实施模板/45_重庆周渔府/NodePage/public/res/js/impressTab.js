...
$(document).ready(function () {
    ...
    $('.Content_Evaluate_submit').click(function () {
        ...
        $.getJSON(host+"/jsonpAction/ShopCommentAction.ashx?SID="+SID+"&comment="+text+
                "&option=OP_ShopCommentAdd&jsoncallback=?",
            function(data){
    ...
    var loadLayer = layer.load("加载中...");
    $.getJSON(host+"/jsonpAction/ShopLabelAction.ashx?SID="+SID+
            "&option=OP_ListAllLabels&jsoncallback=?",
        function(data){
            layer.close(loadLayer);
