        ...
        _layout				: function() {
            ...
            for( var i = 0; i <= this.pagesCount - 2; ++i ) {
                ...
                var	pageData	= {
                    ...
                    theStyle				: 'z-index: ' + ( this.pagesCount - i ) + ';',
...
//                    left	: -_self.windowProp.width / 2
        ...
        _onEndFlip			: function( $page ) {
            ...
            //如果页面翻转从左到右,我们将需要更改翻转页面的z-index
        ...
        _overlay			: function( angle, update ) {
            ...
            //改变每个覆盖层的透明度
            if( update ) {
                // if update is true, meaning we are manually flipping the page,手动翻转页面
